(function () {
  ...
  function isGermanInterface() {
    ...
    return declared.indexOf('de') === 0 || /\u00fcbersicht|kunden|webseiten|\u00fcberwachung|einstellungen/i.test(primary ? primary.textContent : '') || /ispconfig liquid/i.test(footer ? footer.textContent : '');
  }
